...
import EnvironmentVariables from "@/constants/envVars.js"
import { NodeEnvs as NodeEnvironments } from "@/constants/misc.js"
...
const errorHandler: ErrorRequestHandler = (error, _, res, _next) => {
  ...
  console.log("sending", error.status || INTERNAL_SERVER_ERROR)

  return res.sendStatus(error.status || INTERNAL_SERVER_ERROR)
}
